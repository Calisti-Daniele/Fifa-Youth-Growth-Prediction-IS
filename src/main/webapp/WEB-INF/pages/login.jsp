...
<head>
    ...
    <title>Login - Fifa Youth Growth Prediction</title>
    ...
    <div class="flex justify-center mt-10">
        <div class="bg-lime-800 p-6 rounded-lg shadow-lg w-1/3">
            <form action="${pageContext.request.contextPath}/login" method="post">
                ...
                <button type="submit" class="w-full bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Accedi</button>
            </form>

            <p class="text-sm text-center mt-4">
                Non hai un account? <a href="${pageContext.request.contextPath}/redirectRegister" class="text-green-400 hover:underline">Registrati</a>
            </p>
        </div>
    </div>
</div>
